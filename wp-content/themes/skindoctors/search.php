...
<div class="container top130">
	<div class="col-md-8 single list">
        <? 
         ...
         ?>
        <h1><p>Fraza: <span class="btn btn-lg btn-skindoctor"><?php echo $s; ?></span></p></h1>
        <?php
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            $args = array(
                'post_type'     => ['treatments', 'tips', 'news', 'media'],
                'posts_per_page' => 5,
                'paged'=>$paged,
                's' => get_search_query()
            );
                ...
                <a href="<? echo get_post_permalink(); ?>" class="post">
                    ...
                    <div class="row bottom20">
                        ...
                        <div class="col-sm-6">
                            <? if($categories): ?>
                                <? $cat = $categories[0]; ?>
                                <a href="<? echo get_term_link($cat->term_id); ?>" class="btn btn-sm pull-right btn-skindoctor top10"><? echo get_the_category()[0]->name; ?></a>
                            <? endif; ?>
                        </div>
                    </div>
